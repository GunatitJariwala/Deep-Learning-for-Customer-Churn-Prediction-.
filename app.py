...
has_cr_card=st.selection('Has Credit Card',[0,1])
is_active_member=st.selection('Is Active Member',[0,1])
...
input_data=pd.DataFrame({
    ...
    'EstimatedSalary':[estimated_salary] # type: ignore
})
...
if prediction_proba > 0.5:
    print('The customer is likely to churn or leave the company')
else:
